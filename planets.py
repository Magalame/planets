...
#Constantes:
AU=149597870700
lastperi=datetime(2016, 01, 02, 22, 49)     #last perihelion with yyyy/mm/dd/hh/mm/ss/mmmmmm
...
#        print "Coordonnées de la Terre:",coordonneesEarth(deltime),"on",datetime.utcnow().strftime("%A %d %B %H h %M m %S s")
        resultat=coordonneesEarth(deltime)
        result = str(resultat[0]) + " " + str(resultat[1]) + "\n"
...
#return result
        #time.sleep(5)
I am [nbaspi] in [~/Projects/Planets]:cat planets_update2.py
#!/usr/bin/env python
# -*- coding: UTF-8 -*-
#print "Content-Type: text/plain;charset=utf-8"
#print
